...
def compress_context(
    ...
    """
    # Required ACP evidence owns the current turn until it is consumed. This
    # guard must run before snapshotting any compressor state, including for
    # manual/forced compression and minimal test doubles.
