...
_CONTROL_STATE: Dict[str, Any] = {
    ...
    # ACP root required-delegation ownership/observation fence. The owner token
    # is rebound per turn so durable controller records cannot leak across turns.
    "_required_delegation_owner_token": None,
    "_required_delegation_launching": False,
    "_required_observation_failed": False,
    "_required_compression_join_hook": None,
...
_TURN_STATE: Dict[str, Any] = {
    ...
    "_inflight_turn_started": 0.0,
    "_turn_checkin_fired": False,
}
...
_STREAM_STATE: Dict[str, Any] = {
    ...
    # ACP required-delegation streams are held until the completed response is
    # classified, preventing a delegation candidate from leaking to clients.
    "_acp_provisional_stream_active": False,
    "_acp_provisional_stream_buffer": list,
    "_stream_visible_text_started": False,
}
