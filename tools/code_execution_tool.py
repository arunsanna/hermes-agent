...
_TOOL_STUBS = {
    ...
    "terminal": ("command: str, timeout: int = None, workdir: str = None, return_direct: bool = False",
        '"""Run a shell command (foreground only). Returns dict with "output" and "exit_code"."""',
        '{"command": command, "timeout": timeout, "workdir": workdir, "return_direct": return_direct}'),
}
