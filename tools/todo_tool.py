...
TODO_SCHEMA = {
    ...
    "description": (
        ...
        "item. Keep it current: after each verified status change, call this "
        "tool again to publish it. Before giving your final answer, update "
        "every affected item; never leave verified work pending. Always "
