...
def resolve_api_key_provider_credentials(provider_id: str) -> Dict[str, Any]:
    ...
    api_key, key_source = _resolve_api_key_provider_secret(provider_id, pconfig)
    # No-auth local/private gateways: a placeholder so runtime / auxiliary_client see the server
    # as configured. Doctor still reports unconfigured because status uses the raw secret.
