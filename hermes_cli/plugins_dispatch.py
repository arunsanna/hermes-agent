...
class PluginDispatchMixin:
    ...
    def invoke_hook(self, hook_name: str, **kwargs: Any) -> List[Any]:
        ...
        # Compatibility for callers that previously opted into a per-invocation bound. Upstream's
        # config-driven policy remains the default and covers the common turn-path hooks.
        explicit_timeout = kwargs.pop("_timeout_s", None)
        ...
        results: List[Any] = []
        timeout = _resolve_hook_callback_timeout() if explicit_timeout is None else float(explicit_timeout)
