...
DEFAULT_CONFIG = {
    ...
    "agent": {
        ...
        # Soft turn budget. At the next tool-round boundary, ask whether to continue. An explicit
        # run_budget_seconds owns the stronger cutoff instead.
    ...
    # ACP runs unattended over stdio. HERMES_ACP_MAX_ITERATIONS overrides this per process;
